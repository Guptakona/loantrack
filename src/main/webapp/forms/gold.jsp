...
<body>
    ...
    <div class="container">
        ...
        <form action="#" method="POST">
            ...
            <!-- Gold Value -->
            <label for="goldValue">Estimated Gold Value*</label>
            <input type="number" id="goldValue" name="goldValue" placeholder="Enter the estimated value" required>

            <!-- Purpose of Loan -->
            <label for="loanPurpose">Purpose of Loan*</label>
            <input type="text" id="loanPurpose" name="loanPurpose" placeholder="Enter purpose of loan" required>
